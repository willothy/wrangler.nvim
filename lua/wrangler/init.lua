---This is pretty much a clone of Harpoon, but without the terminal stuff and using
...
---@class Wrangler.Project
---@field name string
---@field cwd string

---@class Wrangler.MarksTable: sqlite_tbl

---@class Wrangler.ProjectsTable: sqlite_tbl

---@class Wrangler.MarkDatabase: sqlite_db
---@field marks Wrangler.MarksTable
---@field projects Wrangler.ProjectsTable

local sqlite = require("sqlite.db")

---@class Wrangler
---@field db_path string
---@field private _db Wrangler.MarkDatabase
---@field private _projects Wrangler.ProjectsTable
---@field private _marks Wrangler.MarksTable
local M = {}
...
---@param marks Wrangler.Mark[]
function M._menu_render(marks)
  local lines = vim
    .iter(marks)
    :map(function(mark)
      return mark.file
